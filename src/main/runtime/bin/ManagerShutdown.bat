...
@REM shutdown the database server
...
%JAVACMD% -Xms%JAVA_HEAP_MINIMUM% -Xmx%JAVA_HEAP_MAXIMUM% -classpath "etc;lib\*" %JAVA_OPTS% org.hsqldb.cmdline.SqlTool --rcFile=%MANAGER_CONF% --sql="SHUTDOWN COMPACT;" %MANAGER_URLID%
popd
