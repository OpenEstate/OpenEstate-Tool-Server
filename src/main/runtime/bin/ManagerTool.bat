...
@REM launch a graphical management tool on the database server
...
%JAVACMD% -Xms%JAVA_HEAP_MINIMUM% -Xmx%JAVA_HEAP_MAXIMUM% -classpath "etc;lib\*" %JAVA_OPTS% org.hsqldb.util.DatabaseManagerSwing --rcfile %MANAGER_CONF% --urlid %MANAGER_URLID%
popd
