...
echo "--------------------------------------------------------------"
echo ""
sudo spctl --remove -v --path "$BASE_DIR/ManagerTool.app"
sudo spctl --remove -v --path "$BASE_DIR/Start.app"
set -e
sudo spctl --add -v --label "$LABEL" "$BASE_DIR/ManagerTool.app"
...
echo "--------------------------------------------------------------"
echo ""
xattr -d -r com.apple.quarantine "$BASE_DIR/ManagerTool.app"
...
echo "--------------------------------------------------------------"
echo ""
sudo spctl -v -a "$BASE_DIR/ManagerTool.app"
