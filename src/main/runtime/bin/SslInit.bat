...
@REM generate RSA keypair and certificate for SSL encryption
...
%JAVACMD% -Xms%JAVA_HEAP_MINIMUM% -Xmx%JAVA_HEAP_MAXIMUM% -classpath "etc;lib\*" %JAVA_OPTS% org.openestate.tool.server.utils.SslGenerator %*
popd
